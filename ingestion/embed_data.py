...
embedding_staging_table_name = f"`{catalog_name}`.`{schema_name}`.veeva_qdms_docs_embeddings_staging"
embedding_staging_s3_path=f"s3://gilead-edp-pdm-dev-us-west-2-pdm-dl-quality-docs-genai/{embedding_staging_table_name.split('.')[-1]}/"
