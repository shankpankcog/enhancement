...
db = "gvault_test"
MODEL_NAME = "veeva-qdms-it-demo"
MODEL_NAME_FQN = f"{catalog}.{db}.{MODEL_NAME}"

endpoint_name="pdm-dl-quality-docs-genai-veeva-qdms-it-demo"

input_example = {
    "messages": [
        {
            "role": "user",
            "content": "What is the process for requesting access to GVault?"
        }
    ],
    "custom_inputs": {"filters": {"doc_control_name": "Information Technology","document_type": ["Governance and Procedures"]}},
}
...
with mlflow.start_run(run_name="veeva_qdms_it_demo"):
