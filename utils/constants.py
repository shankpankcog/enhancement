...
metadata_table_name = "`pdm-pdm-dl-quality-docs-genai-dev`.gvault_test.veeva_qdms_docs_metadata"
download_status_table_name = "`pdm-pdm-dl-quality-docs-genai-dev`.gvault_test.download_status"
